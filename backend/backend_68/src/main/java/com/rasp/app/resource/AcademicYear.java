 ...
 */
@Component
 public class AcademicYear extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("academic_year");
	...
	static {
		...
		metaData.setTableName("academic_year");

		metaData.setCluster("rasp_db");
	}

	public AcademicYear() {this.setId(Util.getUniqueId());}
	public AcademicYear(String id) {this.setId(id);}

	public AcademicYear(AcademicYear obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return AcademicYearResult.class;};
	public  Class<?> getMessageClass() {return AcademicYearMessage.class;};
	public  Class<?> getHelperClass() {return AcademicYearHelper.class;};
	public  Class<?> getServiceClass() {return AcademicYearService.class;};
}