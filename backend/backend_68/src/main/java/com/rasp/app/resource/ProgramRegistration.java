 ...
 */
@Component
 public class ProgramRegistration extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("program_registration");
	...
	static {
		...
		metaData.setTableName("program_registration");

		metaData.setCluster("rasp_db");
	}

	public ProgramRegistration() {this.setId(Util.getUniqueId());}
	public ProgramRegistration(String id) {this.setId(id);}

	public ProgramRegistration(ProgramRegistration obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return ProgramRegistrationResult.class;};
	public  Class<?> getMessageClass() {return ProgramRegistrationMessage.class;};
	public  Class<?> getHelperClass() {return ProgramRegistrationHelper.class;};
	public  Class<?> getServiceClass() {return ProgramRegistrationService.class;};
}