...
//           );
//            if (r != null && r.length > 0) ((Student) _resource).setBatch(((Batch) r[0]).getId());
//        }
//        System.out.println("Resource:"+ _resource);
//        String name = student.getName();
//        String email = student.getEmail();
//        String rollNo = student.getRoll_no();     // Correct field
...
//        try {
//            // -----------------------------------------------------
//            // 1️⃣ Create User in "users" resource + Keycloak
//            // -----------------------------------------------------
////            Map<String,Object> userMap = new HashMap<>();
////            userMap.put("resourceName", "users");   // MUST MATCH your resource
////
...
//////                    String.class
//////            );
////            iamService.addUser(S);
////            if (!userResponse.getStatusCode().is2xxSuccessful()) {
////                throw new ApplicationException(ExceptionSeverity.ERROR,
////                        "User creation failed for roll no: " + rollNo);
////            }
//
//            UserResource ur = new UserResource();
//
//            ur.setResourceName("users");
//
//            Map<String, Object> resourceMap = new HashMap<>();
//            resourceMap.put("user_name", rollNo);
//            resourceMap.put("user_email", email);
//
//            ur.setResourceMap(resourceMap);
//
//            Map<String, Object> authMap = new HashMap<>();
//            authMap.put("userName", userName);   // username = rollNo
//            authMap.put("email", email);
//            authMap.put("firstName", firstName);
//            authMap.put("lastName", lastName);
//            authMap.put("password", password);
//
//            ur.setAuthMap(authMap);
//            try {
//                iamService.addUser(ur);
//            } catch (Exception e) {
//                System.out.println("Exception adding user: " + e);
//            }
//            // -----------------------------------------------------
//            // 2️⃣ Assign Role
//            // -----------------------------------------------------
//            Map<String,Object> roleMap = new HashMap<>();
//            roleMap.put("userName", userName); // SAFE
...
////                throw new ApplicationException(ExceptionSeverity.ERROR,
////                        "Role mapping failed for: " + userName);
////            }
//            try {
//                iamService.addUserRoleMapping(roleMap);
//            } catch (Exception e) {
//                System.out.println("Exception Occurred due to role Mapping " + e);
//            }
//
//        } catch (Exception e) {
//            throw new ApplicationException(ExceptionSeverity.ERROR,
