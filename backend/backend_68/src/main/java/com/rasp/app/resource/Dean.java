 ...
 */
@Component
 public class Dean extends BaseResource {
	...
	public static String FIELD_UPDATED_AT = "updated_at";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("dean");
	...
	static {
		...
		signatureField.setFile(true);
		signatureField.setRequired(true);
		metaData.addField(signatureField);

		Field updated_atField = new Field("updated_at", "Date");
		metaData.addField(updated_atField);
		...
		metaData.setTableName("dean");

		metaData.setCluster("rasp_db");
	}

	public Dean() {this.setId(Util.getUniqueId());}
	public Dean(String id) {this.setId(id);}

	public Dean(Dean obj) {
		this.id = obj.id;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		updated_at = (Date) map.get("updated_at");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object updated_atObj = map.get("updated_at");
		if(updated_atObj != null)
			updated_at = new Date(updated_atObj.toString());
	...
	public boolean validateSignature(boolean add) throws ApplicationException {
		if(add && signature == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[signature]");
	...
	public  Class<?> getResultClass() {return DeanResult.class;};
	public  Class<?> getMessageClass() {return DeanMessage.class;};
	public  Class<?> getHelperClass() {return DeanHelper.class;};
	public  Class<?> getServiceClass() {return DeanService.class;};
}