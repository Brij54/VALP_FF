...
public class Registry {
		public static void register(){
				 HelperManager.getInstance().register(AcademicYearHelper.getInstance());
				 ...
				 ServiceManager.getInstance().register(new AcademicYearService());
