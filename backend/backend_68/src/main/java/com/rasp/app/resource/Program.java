 ...
 */
@Component
 public class Program extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("program");
	...
	static {
		...
		Field seatsField = new Field("seats", "Long");
		seatsField.setRequired(true);
		metaData.addField(seatsField);

		Field instructor_nameField = new Field("instructor_name", "String");
		...
		metaData.setTableName("program");

		metaData.setCluster("rasp_db");
	}

	public Program() {this.setId(Util.getUniqueId());}
	public Program(String id) {this.setId(id);}
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object seatsObj = map.get("seats");
		if(seatsObj != null)
			seats = new Long(seatsObj.toString());
	...
	public boolean validateSeats(boolean add) throws ApplicationException {
		if(add && seats == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[seats]");
		return seats != null;
	}
	...
	public String getInstructor_nameEx() {
		return instructor_name != null ? instructor_name : "";
	}
	...
	public void unSetInstructor_name() {
		this.instructor_name = null;
	}

	public boolean validateInstructor_name(boolean add) throws ApplicationException {
	...
	public String getSyllabusEx() {
		return syllabus != null ? syllabus : "";
	}
	...
	public  Class<?> getResultClass() {return ProgramResult.class;};
	public  Class<?> getMessageClass() {return ProgramMessage.class;};
	public  Class<?> getHelperClass() {return ProgramHelper.class;};
	public  Class<?> getServiceClass() {return ProgramService.class;};
}