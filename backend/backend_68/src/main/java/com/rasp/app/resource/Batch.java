...
@Component
 public class Batch extends BaseResource {
	...
	private Long no_of_courses = null;
	...
	public static String FIELD_NO_OF_COURSES = "no_of_courses";
	...
	static {
		...
		Field no_of_coursesField = new Field("no_of_courses", "Long");
		no_of_coursesField.setRequired(true);
		metaData.addField(no_of_coursesField);
	...
	public Batch(Batch obj) {
		...
		this.no_of_courses = obj.no_of_courses;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(no_of_courses != null)
			map.put("no_of_courses", no_of_courses);
		if(extra_data != null)
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		no_of_courses = (map.get("no_of_courses") == null ? null : ((Number) map.get("no_of_courses")).longValue());
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object no_of_coursesObj = map.get("no_of_courses");
		if(no_of_coursesObj != null)
			no_of_courses = new Long(no_of_coursesObj.toString());
	...
	public Long getNo_of_courses() {
		return no_of_courses;
	}

	public void setNo_of_courses(Long no_of_courses) {
		this.no_of_courses = no_of_courses;
	}

	public void unSetNo_of_courses() {
		this.no_of_courses = null;
	}

	public boolean validateNo_of_courses(boolean add) throws ApplicationException {
		if(add && no_of_courses == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[no_of_courses]");
		return no_of_courses != null;
	}
