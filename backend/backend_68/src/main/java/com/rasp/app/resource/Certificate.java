...
@Component
 public class Certificate extends BaseResource {
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		course_duration = (map.get("course_duration") == null ? null : ((Number) map.get("course_duration")).longValue());
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		if(course_completion_dateObj != null)
			course_completion_date = new Date(course_completion_dateObj.toString());
	...
	public  Class<?> getResultClass() {return CertificateResult.class;};
	public  Class<?> getMessageClass() {return CertificateMessage.class;};
	public  Class<?> getHelperClass() {return CertificateHelper.class;};
	public  Class<?> getServiceClass() {return CertificateService.class;};
}